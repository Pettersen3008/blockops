  ...
  return (
    <Card className="min-w-0 p-6 [overflow-wrap:anywhere] max-[660px]:p-[18px]">
      <div className="grid grid-cols-[48px_1fr_auto] items-start gap-3.5 border-b border-border pb-5 max-[660px]:grid-cols-[44px_1fr] [&>div]:min-w-0">
        ...
        <div><p className="eyebrow">Restart required</p><h2 className="mb-1 text-xl">Deployment boundaries</h2><p className="m-0 text-muted-foreground">These values come from the host environment and cannot be widened from the browser.</p></div>
      </div>
